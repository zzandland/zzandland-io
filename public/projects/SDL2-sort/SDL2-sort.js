...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(10, 0, 1, api);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, display, attrib_list, configs, config_size, numConfigs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 0, 1, display, name);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 0, 1, dpy, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 0, 1, display);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(31, 0, 1, status);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(36, 0, 1, width, height);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(37, 0, 1, target, deferUntilInEventHandler, fullscreenStrategy);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(39, 0, 1);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(46, 0, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(63, 0, 1, title);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(66, 0, 1, fd);
